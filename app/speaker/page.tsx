...
/** FAQ data — used for both rendering and FAQPage JSON-LD */
const faqs = [
  {
...
/** Keynote topics — links to individual keynote pages */
const keynoteTopics = [
  {
    ...
    <>
      ...
      <Section width="content" className="text-center">
        <h1 className="text-4xl font-bold tracking-tight text-brand-900 sm:text-5xl md:text-6xl">
          Virtual keynote speaker for curious, modern teams
        </h1>
        <p className="mt-6 text-lg leading-relaxed text-brand-600">
          Nic Haralambous is an entrepreneur, AI product builder, and virtual
          keynote speaker with 4 startup exits, 3 books, and 20+ years building
          technology businesses. He helps distributed teams build cultures of
          experimentation and growth.
        </p>
        <div className="mt-8">
          <CTAButton href="/contact">
            Book Nic for Your Next Virtual Event
          </CTAButton>
        </div>
      </Section>
      ...
      <Section width="wide" className="bg-brand-50">
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <div key={item.title} className="rounded-xl border border-brand-200 bg-surface p-6">
      ...
      {/* Final CTA */}
      <Section width="content" className="bg-accent-600 text-center text-white rounded-none">
